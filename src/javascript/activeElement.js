...
if(actualwindow.toString().split("/").pop() == "index.php"){ //Se il path della pagina attuale è index.html allora aggiungo la classe active all'elemento con id homenavitem
